SELECT  a.fk_sales_order_item_state       id_sales_order_item_state,
        ...
        MAX(b.id_actual_order_state)      actual_id_sales_order_item_state,
        MAX(b.actual_order_state)         actual_order_item_state_name_en
  FROM  aws_s3.sales_order_item_states a
